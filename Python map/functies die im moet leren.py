#functies die ik moet leren voor python:
# import numbers
...
# moet voor de gebruiker een (input) functie geven!!
# je kunt ook de functie (case) gebruiken!!
# je kunt ook de volgende gebruiken: [x = float(input("wat is x? "))]  !!!
# om te kunnen het precentage te programmeren kun je de volgende gebruiken: [answer = x * y / 100]

# hieronder zijn nuttige functies die je kunt gebruiken!
# je kunt ook de volgende gebruiken: print("De vraag is " + str(x) + "% = " + str(y) "?")
# print(f"De vraag is: hoeveel % is {x} can {y}?")
# print(f"het antwoord is: {answer}")
# voorbeeld 1: print(f"De berekening is: {x} : {y} = {x/y}; {x/y} x 100 = {int(round(answer, 0))}%")
# Voorbeeld 2: print(f"De berekening is: {x} : {y} = {x/y}; {x/y} x 100 = {answer:.0f}%")
# print(round(answer))